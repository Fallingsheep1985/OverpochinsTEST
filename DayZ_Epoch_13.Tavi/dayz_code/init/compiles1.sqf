...
if (!isDedicated) then {
	...
	object_setFixServer = compile preprocessFileLineNumbers "origins\object_setFixServer.sqf";	//process the hit as a NORMAL damage (useful for persistent vehicles)
