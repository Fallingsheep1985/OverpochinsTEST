...
_Citys = ["Sabina","Martin","Dalnogorsk","Yaroslav","Lyepestok","Etanvosk","Stari Sad","Seven","Mitrovice","Chernovar","Branibor","Baranovka","Vladamir","Biysh"];	//These have to be markers!!! - Marker names will be displayed as the name of the location
