if(isServer) then {
	...
	/* AI CONFIG */
		...
		ai_gear						= [["ItemBandage"],["ItemRadio","ItemMachete","ItemCrowbar"]];
		...
		ai_gear_random				= [ai_gear0,ai_gear1,ai_gear2,ai_gear3,ai_gear4,ai_gear];	// Allows the possibility of random gear
